...
const fr: Translations = {
  ...
  'dashboard.kpi.read': 'Mails ouverts',
  ...
  'dashboard.progress.read': 'ouverts',
...
const en: Translations = {
  ...
  'dashboard.kpi.contacts': 'contacts',
  'dashboard.kpi.read': 'Emails opened',
  ...
  'dashboard.progress.read': 'opened',
